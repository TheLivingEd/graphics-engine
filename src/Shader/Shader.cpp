...
{
	std::string vertexShaderSource = Utility::Parser(VertexPath); // Build VertexShader
	...
	std::string fragmentShaderSource = Utility::Parser(FragmentPath); // Build FragmentShader
